...
|-----------|-------|-----------------|-----------|-------|
| TC-MEM-001 | 1. Research "Gartner.com"<br>2. Wait for complete response<br>3. Ask: "Tell me about their CEO" | Agent should know you're referring to Gartner and provide CEO info (Eugene Hall) WITHOUT asking "which company?" | ☐ | **CRITICAL** - Previously failed |
| TC-MEM-002 | 1. Research "Salesforce"<br>2. Ask: "What are their revenue numbers?"<br>3. Ask: "Tell me about their AI initiatives"<br>4. Ask: "Who are their main competitors?" | All follow-ups should maintain Salesforce context without re-asking which company | ☐ | Test 4+ follow-ups |
| TC-MEM-003 | 1. Research "Microsoft"<br>2. Ask: "Draft an email to their CTO"<br>3. Ask: "Now draft one for their CFO" | Agent should know both emails are for Microsoft contacts | ☐ | Email context retention |
| TC-MEM-004 | 1. Research "Adobe"<br>2. Ask: "Tell me more about the CEO"<br>3. Ask: "What about the CTO?"<br>4. Ask: "And the CFO?" | Agent maintains company context for all role-based queries | ☐ | Role persistence |
| TC-MEM-005 | 1. Type "m365" or "MS365"<br>2. Observe if agent recognizes Microsoft 365 | Agent should understand shorthand/abbreviations for commonly known products/companies | ☐ | Entity recognition |
...
| Test Case | Steps | Expected Result | Pass/Fail | Notes |
|-----------|-------|-----------------|-----------|-------|
| TC-SETUP-001 | 1. Complete full setup with:<br>   - Company: Keepit<br>   - Competitors: Veeam, Commvault<br>   - Signals: Data breach, Leadership change<br>   - Titles: CISO, CTO, VP Security<br>2. Research any company | Output MUST include sections matching setup using EXACT terminology:<br>- "Signals: Data breach - [findings], Leadership Change - [findings]"<br>- Key contacts section showing CISO, CTO, VP Security with names | ☐ | **CRITICAL** - Use exact wording |
| TC-SETUP-002 | 1. During setup, define 3 custom buying signals<br>2. Research 5 different companies | EVERY research output must check for and report on those 3 signals using the SAME terminology provided | ☐ | Consistency check |
| TC-SETUP-003 | 1. Setup with specific competitor list<br>2. Research target company | Competitive intelligence section must reference YOUR specified competitors, not generic ones | ☐ | Competitor specificity |
| TC-SETUP-004 | 1. Define target titles during setup<br>2. Research company | Key contacts section must prioritize and highlight the EXACT titles specified, using same terminology | ☐ | Currently failing per Asana task |
| TC-SETUP-005 | 1. View setup configuration summary<br>2. Edit one signal<br>3. Research a company<br>4. Verify change is reflected | Changed setup parameters must immediately reflect in next research | ☐ | Dynamic updates |
